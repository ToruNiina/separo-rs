...
export function __wbg_gamegifrecorder_free(a: number): void;
export function gamegifrecorder_new(): number;
export function gamegifrecorder_add_frame(a: number, b: number, c: number): void;
export function gamegifrecorder_dump(a: number, b: number): void;
